...
/// ********************************************************************************************************************
/// VERY IMPORTANT! READ THIS IF YOU DO ANY UI DESIGN IN PENGUIN
...
public class PenguinSceneTabScaler : UIBehaviour
{
    /// <summary>
    ...
    protected PenguinSceneTabScaler() {}
    ...
    public delegate void ScreenSizeUpdatedDelegate(float centerYDelta);

    public static event ScreenSizeUpdatedDelegate ScreenSizeUpdated;
    ...
    protected virtual void HandleScaleWithScreenSize()
    {
        ...
        Vector2 screenSize = TabSceneSpawningManager.RealUISize;
        ...
        ScreenSizeUpdated?.Invoke(TabSceneSpawningManager.YCenterDelta);
    }
